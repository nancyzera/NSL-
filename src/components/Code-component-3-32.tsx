        ...
        >
          ...
          >
            <div className="relative rounded-2xl overflow-hidden glow-box">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1620712943543-bcc4688e7485?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHxyb2JvdGljcyUyMGVkdWNhdGlvbiUyMHRlY2hub2xvZ3klMjBsZWFybmluZ3xlbnwxfHx8fDE3NTczMzU1NTJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                alt="Robotics education and technology learning"
