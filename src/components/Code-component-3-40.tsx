        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-sm">
                ...
                <span className="text-muted-foreground">contact@nsl-learning.com</span>
              </div>
              <div className="flex items-center space-x-3 text-sm">
              ...
              <div className="flex items-center space-x-3 text-sm">
                ...
                <span className="text-muted-foreground">Tech Innovation Hub, Silicon Valley</span>
              </div>
            </div>
          ...
          >
            ...
            <ul className="space-y-3">
              {footerLinks.courses.map((link) => (
                <li key={link}>
                  <button className="text-muted-foreground hover:text-sky-500 transition-colors text-left">
                    {link}
                  </button>
                </li>
              ))}
          ...
          >
            ...
            <div className="space-y-3">
              ...
              />
              <Button className="w-full bg-gradient-to-r from-sky-400 to-sky-600 hover:from-sky-500 hover:to-sky-700 text-white">
                Subscribe
              </Button>
            </div>
